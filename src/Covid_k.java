...
public class Covid_k {
    public static void main (String[] args) {
        ...
        try{
                ...
                if (input != null) {
                    ...
                    if (k <= c) {
                        ...
                        for (int i = 1; i <= k; i++) {
                            ...
                            outputstr += City.getArray()[i].getName() + "\n";
                        }
            ...
            JOptionPane.showMessageDialog(null,"The file was not found"+ f.getName() ,"Error",JOptionPane.WARNING_MESSAGE,new ImageIcon (image2));
        }
        catch (IOException e) {
